...
SAC_C_EXTERN 
/*
 * ND_FUN_DECL( COMPLEXIO__PrintComplexArray, , 4, inout_nodesc_bx, SAC_hidden, (SACl_stream, (SCL, (HID, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (OTH, )))))))))), in_nodesc, int, (SACl_d, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), in_nodesc, int, (SACl_s, (AKD, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), in_nodesc, double, (SACl_a, (AUD, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))))
 */
SAC_ND_DECL_FUN2( COMPLEXIO__PrintComplexArray, void,  SAC_ND_PARAM_inout_nodesc_bx( (SACl_stream, (SCL, (HID, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (OTH, )))))))))), SAC_hidden), SAC_ND_PARAM_in_nodesc( (SACl_d, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), int), SAC_ND_PARAM_in_nodesc( (SACl_s, (AKD, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), int), SAC_ND_PARAM_in_nodesc( (SACl_a, (AUD, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))), double));
...
SAC_C_EXTERN 
/*
 * ND_FUN_DECL( SACf_ComplexIO__print__SACt_Complex__complex_P, , 1, in, double, (SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))))
 */
SAC_ND_DECL_FUN2( SACf_ComplexIO__print__SACt_Complex__complex_P, void,  SAC_ND_PARAM_in( (SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))), double));

SAC_C_EXTERN 
/*
 * ND_FUN_DECL( SACf_ComplexIO__print__SACt_Complex__complex, , 1, in, double, (SACl_c, (AKS, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))))
 */
SAC_ND_DECL_FUN2( SACf_ComplexIO__print__SACt_Complex__complex, void,  SAC_ND_PARAM_in( (SACl_c, (AKS, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))), double));
...
SAC_C_EXTERN 
/*
 * ND_FUN_DECL( SACof__MAIN_CLStdIO__print__SACt_ComplexBasics__complex_1, , 1, in, double, (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))))
 */
SAC_ND_DECL_FUN2( SACof__MAIN_CLStdIO__print__SACt_ComplexBasics__complex_1, void,  SAC_ND_PARAM_in( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))), double));
...
SAC_ND_DEF_FUN_BEGIN2( SACwf__MAIN__main, void,  SAC_ND_PARAM_out( (SAC_arg_1, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), int))
{
  ...
  { 
    /*
     * ND_DECL( (SACp_cwc_60, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, 0)
     */
    SAC_ND_DECL__DATA( (SACp_cwc_60, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, )
    SAC_ND_DECL__DESC( (SACp_cwc_60, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), )
    SAC_NOTHING()


    SAC_INIT_LOCAL_MEM()
    /*
     * ND_FUN_AP( SACf__MAIN__main, , 1, out, int, SAC_SET_NT_USG( FAG, (SACp_cwc_60, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, ))))))))))))
     */
    SAC_ND_FUNAP2( SACf__MAIN__main,  SAC_ND_ARG_out( SAC_SET_NT_USG( FAG, (SACp_cwc_60, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, ))))))))))), int))

    /*
     * ND_REFRESH__MIRROR( (SACp_cwc_60, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0)
     */
    SAC_NOOP()

    /*
     * ND_FUN_RET( , 1, out, (SAC_arg_1, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), (SACp_cwc_60, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))))
     */
    SAC_ND_RET_out( (SAC_arg_1, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), (SACp_cwc_60, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))))
    return;
...
SAC_ND_DEF_FUN_BEGIN2( SACf__MAIN__main, void,  SAC_ND_PARAM_out( (SAC_arg_1, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), int))
{
  ...
  { 
    SAC_ND_DECL_CONST__DATA((SACp_emal_5187__isaa_1200__rso_16_TheWorld, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, 0)
    /*
     * ND_DECL( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, 1, 2)
     */
    SAC_ND_DECL__DATA( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, )
    SAC_ND_DECL__DESC( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), )
    const int SAC_ND_A_MIRROR_SHAPE( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) = 2;
    const int SAC_ND_A_MIRROR_SIZE( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 2;
    const int SAC_ND_A_MIRROR_DIM( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 1;

    /*
     * ND_DECL( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, 2, 1, 2)
     */
    SAC_ND_DECL__DATA( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, )
    SAC_ND_DECL__DESC( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), )
    const int SAC_ND_A_MIRROR_SHAPE( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) = 1;
    const int SAC_ND_A_MIRROR_SHAPE( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1) = 2;
    const int SAC_ND_A_MIRROR_SIZE( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 2;
    const int SAC_ND_A_MIRROR_DIM( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 2;

    /*
     * ND_DECL( (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, 0)
     */
    SAC_ND_DECL__DATA( (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, )
    SAC_ND_DECL__DESC( (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), )
    SAC_NOTHING()

    /*
     * ND_DECL( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, 1, 2)
     */
    SAC_ND_DECL__DATA( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, )
    SAC_ND_DECL__DESC( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), )
    const int SAC_ND_A_MIRROR_SHAPE( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) = 2;
    const int SAC_ND_A_MIRROR_SIZE( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 2;
    const int SAC_ND_A_MIRROR_DIM( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 1;

    /*
     * ND_DECL( (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, 0)
     */
    SAC_ND_DECL__DATA( (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, )
    SAC_ND_DECL__DESC( (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), )
    SAC_NOTHING()

    /*
     * ND_DECL( (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, 1, 1)
     */
    SAC_ND_DECL__DATA( (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, )
    SAC_ND_DECL__DESC( (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), )
    const int SAC_ND_A_MIRROR_SHAPE( (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0) = 1;
    const int SAC_ND_A_MIRROR_SIZE( (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, ))))))))))) = 1;
    const int SAC_ND_A_MIRROR_DIM( (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, ))))))))))) = 1;

    /*
     * ND_DECL( (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, 0)
     */
    SAC_ND_DECL__DATA( (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), int, )
    SAC_ND_DECL__DESC( (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), )
    SAC_NOTHING()
    ...
    SAC_ND_ALLOC_BEGIN((SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 2, 1, double)
    /*
     * ND_SET__SHAPE_arr( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 2)
     */
    SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib/src/structures/ComplexBasics.sac", 33, 9, (SAC_ND_A_DIM( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) == (1)), "Assignment with incompatible types found");
    SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib/src/structures/ComplexBasics.sac", 33, 9, (SAC_ND_A_SHAPE( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) == 2), "Assignment with incompatible types found");
    SAC_NOOP()

    SAC_ND_ALLOC_END((SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 2, 1, double)
    /*
     * ND_CREATE__ARRAY__DATA( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 2, 1.0, 1.0, )
     */
    SAC_ND_WRITE_COPY( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0, 1.0, )
    SAC_ND_WRITE_COPY( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 1.0, )

    SAC_ND_ALLOC_BEGIN((SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 2, double)
    /*
     * ND_SET__SHAPE_arr( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 2, 1, 2)
     */
    SAC_ASSURE_TYPE_LINE ("./Main.sac", 10, 5, (SAC_ND_A_DIM( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) == (2)), "Assignment with incompatible types found");
    SAC_ASSURE_TYPE_LINE ("./Main.sac", 10, 5, (SAC_ND_A_SHAPE( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) == 1), "Assignment with incompatible types found");
    SAC_ASSURE_TYPE_LINE ("./Main.sac", 10, 5, (SAC_ND_A_SHAPE( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1) == 2), "Assignment with incompatible types found");
    SAC_NOOP()

    SAC_ND_ALLOC_END((SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 2, double)
    /*
     * ND_CREATE__ARRAY__DATA( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 2, 2, 1.0, 1.0, )
     */
    SAC_ND_WRITE_COPY( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0, 1.0, )
    SAC_ND_WRITE_COPY( (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 1.0, )

    /*
     * ND_FUN_AP( SACof__MAIN_CLStdIO__print__SACt_ComplexBasics__complex_1, , 1, in, double, SAC_SET_NT_USG( FAG, (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))))
     */
    SAC_ND_FUNAP2( SACof__MAIN_CLStdIO__print__SACt_ComplexBasics__complex_1,  SAC_ND_ARG_in( SAC_SET_NT_USG( FAG, (SACp_emal_5185_a, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))), double))

    /*
     * ND_FUN_AP( SACf_ComplexIO__print__SACt_Complex__complex, , 1, in, double, SAC_SET_NT_USG( FAG, (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))))
     */
    SAC_ND_FUNAP2( SACf_ComplexIO__print__SACt_Complex__complex,  SAC_ND_ARG_in( SAC_SET_NT_USG( FAG, (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))), double))

    SAC_ND_ALLOC_BEGIN((SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 0, double)
    /*
     * ND_SET__SHAPE_arr( (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0)
     */
    SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib-build/src-mt_pth/structures/ArrayBasics.sac", 152, 3086, (SAC_ND_A_DIM( (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) == (0)), "Assignment with incompatible types found");
    SAC_NOOP()

    SAC_ND_ALLOC_END((SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 0, double)
    SAC_ND_CREATE__SCALAR__DATA((SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1.0)
    SAC_ND_ALLOC_BEGIN((SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1, 0, int)
    /*
     * ND_SET__SHAPE_arr( (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0)
     */
    SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib-build/src-cuda/structures/ComplexArrayBasics.sac", 102, 3, (SAC_ND_A_DIM( (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, ))))))))))) == (0)), "Assignment with incompatible types found");
    SAC_NOOP()

    SAC_ND_ALLOC_END((SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1, 0, int)
    SAC_ND_ALLOC_BEGIN((SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1, 0, int)
    /*
     * ND_SET__SHAPE_arr( (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0)
     */
    SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib-build/src-cuda/structures/ComplexArrayBasics.sac", 102, 3, (SAC_ND_A_DIM( (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, ))))))))))) == (0)), "Assignment with incompatible types found");
    SAC_NOOP()

    SAC_ND_ALLOC_END((SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1, 0, int)
     ...
     */
    {
      ...
      /*
       * WL_DECLARE_SHAPE_FACTOR( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1)
       */
      int SAC_WL_SHAPE_FACTOR( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0);

      /*
       * WL_DEFINE_SHAPE_FACTOR( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1)
       */
      {
        int SAC_i;
        SAC_WL_SHAPE_FACTOR( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) = 1;
      }

      /*
       * MT_SCHEDULER_BEGIN( 0, 1, 0, 2)
       */
      SAC_WL_MT_SCHEDULE_START( 0) = 0;
      SAC_WL_MT_SCHEDULE_STOP( 0) = 2;

      /*
       * WL_INIT_OFFSET( (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1)
       */
      SAC_ND_WRITE( (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0)
        = SAC_WL_MT_SCHEDULE_START( 0) * SAC_WL_SHAPE_FACTOR( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0);

      SAC_WL_STRIDE_LOOP0_BEGIN(0, (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0, 2, 1)
      SAC_WL_GRID_UNROLL_BEGIN(0, (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0, 1)
      /*
       * WL_ASSIGN( (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0, (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 1, (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), )
       */
      SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib-build/src-cuda/structures/ComplexArrayBasics.sac", 104, 11, (SAC_ND_A_DIM( (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) == (SAC_ND_A_DIM( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) - SAC_ND_A_SIZE( (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, ))))))))))))), "WL expression with illegal dimension found!");
      SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib-build/src-cuda/structures/ComplexArrayBasics.sac", 104, 11, (SAC_ND_A_SIZE( (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) == SAC_WL_SHAPE_FACTOR( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0)), "WL expression with illegal size found!");
      SAC_ND_WRITE_READ_COPY( (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), SAC_ND_READ( (SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0), (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0, );

      SAC_WL_INC_OFFSET((SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), (SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))))
      SAC_WL_GRID_UNROLL_END(0, (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0, 1)
      SAC_WL_STRIDE_LOOP_END(0, (SACp_wlsb_1010, (AKS, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), (SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), 0, 2, 1)
      /*
       * MT_SCHEDULER_END( 0, 1, 0, 2)
       */
    ...
    SAC_ND_LABEL(_comp_5693_SAC_label)
    SAC_ND_FREE((SACp_wlsw_1006, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), )
    SAC_ND_FREE((SACp_emal_5184__pinl_305__flat_405__SSA2_1, (SCL, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), )
    SAC_ND_FREE((SACp_wlidx_5013__pinl_297_res, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))), )
    /*
     * ND_FUN_AP( SACf_ComplexIO__print__SACt_Complex__complex, , 1, in, double, SAC_SET_NT_USG( FAG, (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))))
     */
    SAC_ND_FUNAP2( SACf_ComplexIO__print__SACt_Complex__complex,  SAC_ND_ARG_in( SAC_SET_NT_USG( FAG, (SACp_emal_5186__flat_2, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))), double))

    SAC_ND_ALLOC_BEGIN((SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 1, double)
    /*
     * ND_SET__SHAPE_arr( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 2)
     */
    SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib/src/structures/ComplexScalarArith.sac", 34, 9, (SAC_ND_A_DIM( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) == (1)), "Assignment with incompatible types found");
    SAC_ASSURE_TYPE_LINE ("//builds/sac-group/build-sac-pkgs/stdlib/src/structures/ComplexScalarArith.sac", 34, 9, (SAC_ND_A_SHAPE( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) == 2), "Assignment with incompatible types found");
    SAC_NOOP()

    SAC_ND_ALLOC_END((SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 1, double)
    /*
     * ND_CREATE__ARRAY__DATA( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 2, 0.0, 2.0, )
     */
    SAC_ND_WRITE_COPY( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0, 0.0, )
    SAC_ND_WRITE_COPY( (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1, 2.0, )

    /*
     * ND_FUN_AP( SACf_ComplexIO__print__SACt_Complex__complex, , 1, in, double, SAC_SET_NT_USG( FAG, (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))))
     */
    SAC_ND_FUNAP2( SACf_ComplexIO__print__SACt_Complex__complex,  SAC_ND_ARG_in( SAC_SET_NT_USG( FAG, (SACp_emal_5181__pinl_958__flat_85, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))), double))

    /*
     * ND_FUN_RET( , 1, out, (SAC_arg_1, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), (SACp_emal_5187__isaa_1200__rso_16_TheWorld, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))))
     */
    SAC_ND_RET_out( (SAC_arg_1, (SCL, (NHD, (NUQ, (INT, (GLO, (FPM, (NOT, (NDI, (INT, )))))))))), (SACp_emal_5187__isaa_1200__rso_16_TheWorld, (SCL, (NHD, (NUQ, (INT, (GLO, (NON, (NOT, (NDI, (INT, )))))))))))
    return;
    SAC_CLEANUP_LOCAL_MEM()
  }
/*
...
/****************************************************************************
 * _MAIN:StdIO::SACof__MAIN_CLStdIO__print__SACt_ComplexBasics__complex_1(...) [ body ]
 ****************************************************************************/
/*
 * ND_FUN_DEF_BEGIN( SACof__MAIN_CLStdIO__print__SACt_ComplexBasics__complex_1, , 1, in, double, (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))))
 */
SAC_ND_DEF_FUN_BEGIN2( SACof__MAIN_CLStdIO__print__SACt_ComplexBasics__complex_1, void,  SAC_ND_PARAM_in( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))), double))
{
  SAC_HM_DEFINE_THREAD_STATUS( SAC_HM_single_threaded)
  SAC_MT_DEFINE_ST_SELF()
  ...
  { 
    /*
     * ND_DECL( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, -1)
     */
    SAC_ND_DECL__DATA( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), double, )
    SAC_ND_DECL__DESC( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), )
    int SAC_ND_A_MIRROR_SIZE( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 0;
    int SAC_ND_A_MIRROR_DIM( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 0;


    /*
     * ND_DECL__MIRROR_PARAM( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 2, 1, 2)
     */
    const int SAC_ND_A_MIRROR_SHAPE( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) = 1;
    const int SAC_ND_A_MIRROR_SHAPE( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1) = 2;
    const int SAC_ND_A_MIRROR_SIZE( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 2;
    const int SAC_ND_A_MIRROR_DIM( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = 2;

    SAC_INIT_LOCAL_MEM()
    /*
     * ND_ASSIGN( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), -1, (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 2, )
     */
    SAC_ND_A_DESC( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = SAC_ND_A_DESC( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))));
    SAC_ND_A_MIRROR_SIZE( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = SAC_ND_A_SIZE( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))));
    SAC_ND_A_MIRROR_DIM( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = SAC_ND_A_DIM( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))));
    SAC_ND_A_DESC_SHAPE( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0) = SAC_ND_A_SHAPE( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 0);
    SAC_ND_A_DESC_SHAPE( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1) = SAC_ND_A_SHAPE( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), 1);
    SAC_ND_A_DESC_SIZE( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = SAC_ND_A_SIZE( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))));
    SAC_ND_A_DESC_DIM( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))) = SAC_ND_A_DIM( (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))));
    SAC_ND_ASSIGN__DATA( (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, )))))))))), )

    /*
     * ND_FUN_AP( SACf_ComplexIO__print__SACt_Complex__complex_P, , 1, in, double, SAC_SET_NT_USG( FAG, (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))))
     */
    SAC_ND_FUNAP2( SACf_ComplexIO__print__SACt_Complex__complex_P,  SAC_ND_ARG_in( SAC_SET_NT_USG( FAG, (_tcp_5692_SACl_arr, (AUD, (NHD, (NUQ, (FLO, (GLO, (NON, (NOT, (NDI, (DOU, ))))))))))), double))
...
/*
   * ND_FUN_DEF_END( SACof__MAIN_CLStdIO__print__SACt_ComplexBasics__complex_1, , 1, in, double, (SACl_arr, (AKS, (NHD, (NUQ, (FLO, (GLO, (FPM, (NOT, (NDI, (DOU, )))))))))))
   */
}
SAC_ND_FUN_DEF_END2()
...
int main( int __argc, char *__argv[])
{
  ...
  SAC_RTSPEC_SETUP_INITIAL(2, " -check t Main.sac", "sac2c");
  SAC_PF_SETUP();
  SAC_HM_SETUP();
  SAC_MT_SETUP();
  SAC_CS_SETUP();
