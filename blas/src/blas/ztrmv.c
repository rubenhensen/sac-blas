...
void SACztrmv(const char uplo, const char trans, const char diag, const int n, const void *a, const int lda, void *x, const int incx) {
  ...
  cblas_ztrmv(CblasRowMajor, u, t, d, n, a, lda, x, incx);
}
